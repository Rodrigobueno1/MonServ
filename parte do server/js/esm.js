...
esm.getPasswd = function() {
    ...
    $.get('libs/'+module+'.php', function(data) {
        ...
        for (var line in dado)
        {
            var html = '';
            html += '<tr>';
            html += '<td>'+dado[line].username+'</td>';
            html += '<td>'+dado[line].password+'</td>';
            html += '<td class="t-center">'+dado[line].uid+'</td>';
            html += '<td class="t-center">'+dado[line].gid+'</td>';
            html += '<td class="t-center">'+dado[line].useridinfo+'</td>';
            html += '</tr>';
